...
?>	    
        <script>
         Swal.fire(
            ...
            setTimeout(function() {
              window.location = 'iced_coffee.php';
            }, delayInMilliseconds);
        </script>     
        <?php
...
?>
    ...
    <div class="container conprod">
        ...
        <h1 class="mb-3">ICED COFFEE PRODUCTS</h1>
        <div class="row">
...
<div class="modal fade" id="addmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="iced_coffee.php"  method="POST" enctype="multipart/form-data">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="iced_coffee.php" method="POST">
      <div class="modal-body">
