...
if(isset($_POST['update'])){
    ...
    $stocks 			= $_POST['stocks'];
    $categories 			= $_POST['categories'];
    mysqli_query($dbcon, "UPDATE products SET product_name = '$product_name', product_description = '$product_description', product_price = '$product_price', image = '$image', stocks = '$stocks', categories = '$categories' WHERE id = '$update_id'"); 
?>	    
        <script>
         Swal.fire(
              'Success!',
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="products.php"  method="POST" enctype="multipart/form-data">
        ...
        <label for="cat" class="cat">Categories:</label>
            <select class="catt" name="categories" id="categories">
